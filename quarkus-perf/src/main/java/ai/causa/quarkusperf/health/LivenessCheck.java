 ...
 *
 * <p>Exposes both chaos knob states in the response data so the signal
 * is clearly attributed in Kubernetes events:
 * <ul>
...
public class LivenessCheck implements HealthCheck {
    ...
    private static final double HEAP_FAIL_THRESHOLD = 0.90;
    ...
    public HealthCheckResponse call() {
        ...
        return HealthCheckResponse.named("quarkus-perf/liveness")
                .status(alive)
