package ai.causa.quarkusperf.load;
 ...
 * <tr><td>TARGET_HOST</td><td>quarkus-perf-svc</td><td>Service hostname</td></tr>
 * <tr><td>TARGET_PORT</td><td>8080</td><td>Service port</td></tr>
...
public class LoadGenerator {
    ...
    private static final String TARGET_HOST      = env("TARGET_HOST",      "quarkus-perf-svc");
    private static final int    TARGET_PORT      = intEnv("TARGET_PORT",   8080);
    ...
    private static final int    BOOKING_RATIO    = intEnv("BOOKING_RATIO",  50);
    ...
    public static void main(String[] args) throws Exception {
        configureLogging();
        LOG.info("=== Quarkus Perf Load Generator starting ===");
        ...
        reporter.scheduleAtFixedRate(LoadGenerator::printStats, 30, 30, TimeUnit.SECONDS);
    ...
    private static void sendTransactionRequest(int workerId, Random rng) {
        ...
        sendPost(BASE_URL + "/api/accounts/" + accountId + "/transactions", body, workerId);
    }
    ...
    private static void sendBookingRequest(int workerId, Random rng) {
        ...
        sendPost(BASE_URL + "/api/bookings", body, workerId);
    }
    ...
    private static void waitForReady() throws InterruptedException {
        String healthUrl = BASE_URL + "/q/health/ready";
    ...
    private static void printStats() {
        ...
        LOG.info(String.format(
                ...
                total > 0 ? (errors * 100.0 / total) : 0.0, avgMs));
    }
