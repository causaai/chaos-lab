package ai.causa.quarkusperf.rest;
...
public class AccountResource {
    ...
    public Response listAccounts() {
        String correlationId = UUID.randomUUID().toString();
        long start = System.currentTimeMillis();
        LOG.infof("[%s] GET /api/accounts", correlationId);
    ...
    public Response getAccount(
        ...
        String correlationId = UUID.randomUUID().toString();
        long start = System.currentTimeMillis();
        LOG.infof("[%s] GET /api/accounts/%s", correlationId, accountId);
    ...
    public Response getTransactionHistory(
        ...
        String correlationId = UUID.randomUUID().toString();
        long start = System.currentTimeMillis();
        LOG.infof("[%s] GET /api/accounts/%s/transactions?limit=%d", correlationId, accountId, limit);
    ...
    public Response submitTransaction(
        ...
        String correlationId = UUID.randomUUID().toString();
        long start = System.currentTimeMillis();
        LOG.infof("[%s] POST /api/accounts/%s/transactions type=%s amount=%s",
        ...
        try {
            ...
            LOG.errorf("[%s] Transaction failed: %s", correlationId, e.getMessage());
            return Response.status(Response.Status.INTERNAL_SERVER_ERROR)
                    .entity(ApiResponse.error("Transaction processing failed", "INTERNAL_ERROR", correlationId))
                    .build();
        }
    }
